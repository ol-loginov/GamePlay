...
# external-deps
GAMEPLAY_DEPS_DIR := $(call my-dir)/../../../external-deps
GAMEPLAY_DEPS := $(GAMEPLAY_DEPS_DIR)/lib/android/$(TARGET_ARCH_ABI)

# libgameplay-deps
include $(CLEAR_VARS)
LOCAL_PATH := $(GAMEPLAY_DEPS)
LOCAL_MODULE    := gameplay-deps 
...
LOCAL_CFLAGS := -D__ANDROID__ -I$(GAMEPLAY_DEPS_DIR)/include
